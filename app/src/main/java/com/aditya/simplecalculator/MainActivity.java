package com.aditya.simplecalculator;
...
import com.aditya.simplecalculator.databinding.ActivityMainBinding;

public class MainActivity extends AppCompatActivity {
    private ActivityMainBinding binding; //step two of gradle data binding method
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_main); //step 3 of using gradle data binding method
